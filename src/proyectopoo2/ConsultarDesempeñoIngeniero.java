...
public class ConsultarDesempeñoIngeniero extends javax.swing.JFrame {

    public Proyecto proyecto; 
    DefaultTableModel modeloTablaTareas;
    DefaultTableModel modeloTablaIngenieros;

    public ConsultarDesempeñoIngeniero(Proyecto proyecto) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 880, 100));
